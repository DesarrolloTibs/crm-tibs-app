...
| [`tenantsService.ts`](file:///c:/Users/sopor/Proyectos/CRM/crm-tibs-app/src/services/tenantsService.ts) | `getTenants`, `getTenantById`, `getMyTenantInfo`, `getTenantConsumption`, `getTenantRenewalQueue`, `updateTenantPlan`, `enqueueTenantRenewal`, `updateQueueItem`, `removeQueueItem`, `clearRenewalQueue`, `updateAllowExtra`, `updateTenant`, `deleteTenant` | `GET/POST/PUT/PATCH/DELETE /api/tenants/*` | `TenantPlanInfo[]`, `TenantConsumptionData`, `RenewalQueueResponse` |
