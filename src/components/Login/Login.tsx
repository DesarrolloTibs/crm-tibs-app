...
const Login: React.FC = () => {
    ...
    return (
        <div className="flex min-h-screen w-full overflow-hidden bg-white">
            ...
            {/* Sección Izquierda: Formulario (Limpio y Profesional) */}
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white z-10 relative">
                            ...
                            <div className="relative group">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-300 hover:text-blue-600 hover:bg-slate-50 transition-all p-1.5 rounded-lg"
                                        tabIndex={-1}
                ...
                {/* Decoración lateral sutil en el lado izquierdo si se desea */}
                <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-600 to-indigo-600"></div>
            </div>

            {/* Sección Derecha: Energy River (Visual Experience) */}
